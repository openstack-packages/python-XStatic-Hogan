...
Version:        XXX
Release:        1%{?dist}
Summary:        Hogan JavaScript library packaged for setuptools

License:        ASL 2.0
URL:            http://git.openstack.org/cgit/stackforge/xstatic-hogan/
...
%description
Hogan javascript library packaged for
...
%{python_sitelib}/xstatic/pkg/hogan
